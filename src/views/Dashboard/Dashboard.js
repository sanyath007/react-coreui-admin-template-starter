      ...
      <div className="animated fadeIn">
        ...
        <Row>
          <DashboardCard
            ...
            chartOptions={cardChartOpts2}
            bgClass={'text-white bg-info'}
            chartWrapper={'chart-wrapper mx-3'}
            chartType={'line'} />
          ...
          <DashboardCard
            ...
            chartOptions={cardChartOpts1}
            bgClass={'text-white bg-primary'}
            chartWrapper={'chart-wrapper mx-3'}
            chartType={'line'} />
          ...
          <DashboardCard
            ...
            chartOptions={cardChartOpts3}
            bgClass={'text-white bg-warning'}
        ...
        <Row>
          <Col>
            <Table hover responsive className="table-outline mb-4 d-none d-sm-table" style={{ backgroundColor: '#fff' }}>
